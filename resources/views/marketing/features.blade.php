<x-layouts.marketing title="Features - Kynex AI Booking">
    <section class="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div class="max-w-3xl">
            <div class="text-sm font-semibold uppercase tracking-[0.24em] text-[var(--brand)]">Features</div>
            <h1 class="mt-4 text-5xl font-semibold tracking-tight text-[var(--text-strong)] lg:text-6xl">Everything you need to run an AI front desk that saves time and captures more bookings.</h1>
        ...
        <div class="mt-12 grid gap-5 lg:grid-cols-2">
            @foreach ([
                ...
                ['title' => 'Multi-Channel Front Desk', 'items' => ['WhatsApp', 'Messenger', 'Voice', 'Future SMS and web chat expansion path']],
                ...
                <div class="rounded-[2rem] border border-[var(--border-subtle)] bg-[var(--surface-1)]/82 p-8">
                    <h2 class="text-2xl font-semibold text-[var(--text-strong)]">{{ $feature['title'] }}</h2>
    ...
    <section class="border-y border-[var(--border-subtle)] bg-[var(--surface-2)]/90">
        <div class="mx-auto max-w-7xl px-6 py-16 lg:px-8">
            <div class="grid gap-8 lg:grid-cols-2">
                <div class="rounded-[2rem] border border-[var(--border-subtle)] bg-[var(--surface-1)]/82 p-8">
                    <div class="text-sm font-semibold uppercase tracking-[0.24em] text-[var(--brand)]">Trust and compliance</div>
                    <div class="mt-5 grid gap-3 text-sm text-[var(--text-muted)]">
                ...
                <div class="rounded-[2rem] border border-[var(--border-subtle)] bg-[var(--surface-1)]/82 p-8">
                    <div class="text-sm font-semibold uppercase tracking-[0.24em] text-[var(--brand)]">Channel roadmap</div>
                    <div class="mt-5 grid gap-3 text-sm text-[var(--text-muted)]">
                        <div>WhatsApp</div>
                        <div>Messenger</div>
                        <div>Voice</div>
                        <div>Future SMS rollout</div>
    ...
    <section class="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div class="rounded-[2rem] border border-indigo-400/20 bg-gradient-to-br from-indigo-500/15 via-white/80 to-cyan-400/10 p-10 text-center dark:via-slate-950">
            <h2 class="text-4xl font-semibold text-[var(--text-strong)]">See how Kynex AI Booking fits your front desk operation.</h2>
            ...
            <div class="mt-8 flex flex-wrap justify-center gap-4">
                <a href="{{ route('marketing.pricing') }}" class="btn-primary rounded-full px-6 py-3 text-sm font-semibold">View Pricing</a>
                <a href="https://kynexsolutions.com" target="_blank" rel="noreferrer" class="btn-secondary rounded-full px-6 py-3 text-sm font-semibold">Book a Demo</a>
            </div>
        </div>
    </section>
</x-layouts.marketing>
