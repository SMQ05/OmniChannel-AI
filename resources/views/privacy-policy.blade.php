<x-guest-layout>
    <div class="panel sm:max-w-3xl w-full mx-auto p-8 my-10">
        <h1 class="text-3xl font-bold text-[var(--text-strong)] mb-6">Privacy Policy</h1>
        
        <div class="max-w-none text-[var(--text-base)]">
            <p class="mb-4">Last updated: {{ now()->format('Y-m-d') }}</p>

            <h2 class="text-xl font-semibold text-[var(--text-strong)] mt-8 mb-4">1. Introduction</h2>
            <p class="mb-4">Welcome to our application. We respect your privacy and are committed to protecting your personal data.</p>

            <h2 class="text-xl font-semibold text-[var(--text-strong)] mt-8 mb-4">2. Data We Collect</h2>
            ...
            <h2 class="text-xl font-semibold text-[var(--text-strong)] mt-8 mb-4">3. How We Use Your Data</h2>
            ...
            <h2 class="text-xl font-semibold text-[var(--text-strong)] mt-8 mb-4">4. Third-Party Services</h2>
            ...
            <h2 class="text-xl font-semibold text-[var(--text-strong)] mt-8 mb-4">5. Contact Us</h2>
