...
<div class="space-y-6">
        ...
        <div class="flex flex-wrap items-end justify-between gap-4">
            ...
            <form method="GET" action="{{ route('admin.voice.index') }}" class="flex items-end gap-3">
                <div>
                    ...
                    <select name="business" class="min-w-64 rounded-lg border border-gray-700 bg-gray-950 px-3 py-2 text-sm text-white">
    ...
    @if($selectedBusiness && $selectedVoiceState)
        ...
        <div class="grid gap-6 xl:grid-cols-2">
            <form method="POST" action="{{ route('admin.voice.update', $selectedBusiness) }}" class="rounded-2xl border border-gray-800 bg-gray-900/60 p-6 space-y-5">
                @csrf
                @method('PATCH')
        ...
        <div class="grid gap-6 xl:grid-cols-2">
            <form method="POST" action="{{ route('admin.voice.channels.store', $selectedBusiness) }}" class="rounded-2xl border border-gray-800 bg-gray-900/60 p-6 space-y-4">
                @csrf
        ...
        <div class="grid gap-6 xl:grid-cols-2">
            <div class="rounded-2xl border border-gray-800 bg-gray-900/60 p-6 space-y-4">
                ...
                <form method="POST" action="{{ route('admin.voice.test', [$selectedBusiness, 'transport']) }}" class="grid gap-3 rounded-xl border border-gray-800 p-4">
                    @csrf
                ...
                <form method="POST" action="{{ route('admin.voice.test', [$selectedBusiness, 'stt']) }}" class="grid gap-3 rounded-xl border border-gray-800 p-4">
                    @csrf
                ...
                <form method="POST" action="{{ route('admin.voice.test', [$selectedBusiness, 'llm']) }}" class="grid gap-3 rounded-xl border border-gray-800 p-4">
                    @csrf
                ...
                <form method="POST" action="{{ route('admin.voice.test', [$selectedBusiness, 'tts']) }}" class="grid gap-3 rounded-xl border border-gray-800 p-4">
                    @csrf
